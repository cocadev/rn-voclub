...
class Home extends Component {
  ...
  searchPressed(text) {
    ...
    if(this.state.keyword!=''){
      ...
      this.props.changeTab('DealsList',"Offers");
      this.props.navigation.dispatch(NavigationActions.navigate({routeName:'DealsList', params:{'cat':"Offers", 'keyword':this.state.keyword}}));
