        ...
        return <View style={Styles.containerNoPadding}>
                ...
                <View style={topup.wrapper}>
                    ...
                    <View style={topup.bottom}>
                            ...
                            <Text style={topup.note}>Please note, that on the event of an unsuccessful charge attempt at whichever slab (7.00 AED / 5.00 AED / 3.00 AED), subsequent charge attempts will be triggered for the next lower until all charge attempts have been exhausted.  The corresponding number of credits will then be awarded based on whichever amount was successfully charged - 3 / 2 / 1 credits respectively.</Text>
